...
RoomPresenceBeaconDevice.prototype.handleAdvertisingForDevice = function(prop) {
    if(prop.RSSI) {
        //TODO: for some reason, I'm seeing TxPower values of "10", which doesn't really make sense
        const distance = RoomPresenceBeaconDevice.CALCULATE_DISTANCE(prop.RSSI, prop.TxPower);
