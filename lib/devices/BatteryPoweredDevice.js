...
BatteryPoweredDevice.prototype.poll = async function() {
    ...
    try {
        await this.waitForServicesResolved(this.maxDelayAfterConnect)
    } catch(e) {
        console.error(this.friendlyName, e, "while awaiting service discovery");
...
BatteryPoweredDevice.prototype.destroy = function(callback) {
    this.destroyed = true;
...
BatteryPoweredDevice.MQTT_PREFIX = "battery_powered_ble_device/";
