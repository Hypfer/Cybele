...
GlanceClockDevice.prototype.executionHelper = function(callback) { //TODO: queue commands and execute only one at a time
    const self = this;
    let retryCount = 0;
 ...
 * @param callback
 */
GlanceClockDevice.prototype.timerSet = function(options, callback) {
...
GlanceClockDevice.prototype.timerStop = function(callback) {
