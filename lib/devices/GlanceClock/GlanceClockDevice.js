...
GlanceClockDevice.prototype.executionHelper = function(callback) {
    ...
    async function executionHelperHelper(callback) { //This. Name.
        ...
        if(self.settingsCharacteristicInterface) {
            ...
            try {
                self.settingsCharacteristicInterface = await self.getDBusInterfaceAsync(
                ...
                console.info("ExecutionHelper: Got Error " + e + " Retrying for " + self.friendlyName);
                return errorRetryHelper(callback);
            }
        }
    }
...
//TODO: if there are no settings, save some defaults
