...
class EqivaThermostatDevice extends PollingDevice {
    /**
     *
    ...
    sendOffsetCommand(offset, callback) {
    ...
    sendBoostModeCommand(boost, callback) {
    ...
    sendTargetTemperatureCommand(temp, callback) {
