...
OralBToothbrushDevice.prototype.handleAdvertisingForDevice = function(props) {
    ...
    if(props.ManufacturerData) {
        ...
        this.mqttClient.publish("cybele/toothbrush/" + this.id + "/presence", parsedData.state > 0 ? "online" : "offline");
        this.mqttClient.publish("cybele/toothbrush/" + this.id + "/state", OralBToothbrushDevice.STATES[parsedData.state]);
