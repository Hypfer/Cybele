 ...
 * @pmoaram topics.key {string}
 * @param topics.suffix {string}
 */
MqttHandler.prototype.setCommandTopics = function(topics) {
    topics.forEach(s => {
        this.commandTopics[s.key] = this.prefix + "/" + this.device.id + "/" + s.suffix
    })
};
