...
//TODO: periodically poll Adapter.Discovering and restart it if it's off
/**
 * @param options {object}
 * @param options.bus
 * @param options.hciDevice {string}
 * @param options.mode {"le"|"bredr"|"auto"}
 * @param [options.scanRestartInterval] {number}
...
const Dongle = function Dongle(options) {
    ...
    this.scanRestartInterval = options.scanRestartInterval;
